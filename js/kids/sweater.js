...
//Winter Wear boys Clothing- Sweatshirts & Sweaters 1
var sweater = [
   "Images/kid-ss1.jpg",
   "Images/kid-ss1-2.jpg",
   "Images/kid-ss1-3.jpg",
];
var ss = 0;
document.sweater1.src = "Images/kid-ss1.jpg";
function setSweater() {
...
function buyss1() {
   ...
   if (buySweater <= 10 && buySweater > 0) {
      document.querySelector("#total-ss1").textContent =
         "Total Price : " + "₹" + 417 * buySweater + "  only";
...
function ss1Type2() {
   document.sweater1.src = "Images/kid-ss1-4.jpg";
...
function ss1Type3() {
   document.sweater1.src = "Images/kid-ss1-5.jpg";
...
function ss1Type4() {
   document.sweater1.src = "Images/kid-ss1-6.jpg";
...
function ss1Type5() {
   document.sweater1.src = "Images/kid-ss1-7.jpg";
...
function ss1Type6() {
   document.sweater1.src = "Images/kid-ss1-8.jpg";
...
//Winter Wear boys Clothing- Sweatshirts & Sweaters 2
var sweater1 = [
   "Images/kid-ss2.jpg",
   "Images/kid-ss2-2.jpg",
   "Images/kid-ss2-3.jpg",
];
var ss1 = 0;
document.sweater2.src = "Images/kid-ss2.jpg";
...
function ss2Type2() {
   document.sweater2.src = "Images/kid-ss2-4.jpg";
...
function ss2Type3() {
   document.sweater2.src = "Images/kid-ss2-5.jpg";
...
function ss2Type4() {
   document.sweater2.src = "Images/kid-ss2-6.jpg";
...
//Winter Wear boys Clothing- Sweatshirts & Sweaters 3
var sweater2 = [
   "Images/kid-ss3.jpg",
   "Images/kid-ss3-2.jpg",
   "Images/kid-ss3-3.jpg",
];
var ss2 = 0;
document.sweater3.src = "Images/kid-ss3.jpg";
...
function buyss3() {
   ...
   if (buySweater <= 10 && buySweater > 0) {
      document.querySelector("#total-ss3").textContent =
         "Total Price : " + "₹" + 999 * buySweater + "  only";
...
function ss3Type2() {
   document.sweater3.src = "Images/kid-ss3-4.jpg";
...
function ss3Type3() {
   document.sweater3.src = "Images/kid-ss3-5.jpg";
...
//Winter Wear boys Clothing- Sweatshirts & Sweaters 4
var sweater3 = [
   "Images/kid-ss4.jpg",
   "Images/kid-ss4-2.jpg",
   "Images/kid-ss4-3.jpg",
];
var ss3 = 0;
document.sweater4.src = "Images/kid-ss4.jpg";
...
//Winter Wear boys Clothing- Sweatshirts & Sweaters 5
var sweater4 = [
   "Images/kid-ss5.jpg",
   "Images/kid-ss5-2.jpg",
   "Images/kid-ss5-3.jpg",
];
var ss4 = 0;
document.sweater5.src = "Images/kid-ss5.jpg";
...
function buyss5() {
   ...
   if (buySweater <= 10 && buySweater > 0) {
      document.querySelector("#total-ss5").textContent =
         "Total Price : " + "₹" + 769 * buySweater + "  only";
...
//Winter Wear boys Clothing- Sweatshirts & Sweaters 6
var sweater5 = [
   "Images/kid-ss6.jpg",
   "Images/kid-ss6-2.jpg",
   "Images/kid-ss6-3.jpg",
];
var ss5 = 0;
document.sweater6.src = "Images/kid-ss6.jpg";
...
function buyss6() {
   ...
   if (buySweater <= 10 && buySweater > 0) {
      document.querySelector("#total-ss6").textContent =
         "Total Price : " + "₹" + 518 * buySweater + "  only";
      alert("Thank ♥ you for Your Order");
   } else if (buySweater === 0) {
      alert("Enter valid number");
   } else {
...
function ss6Type1() {
   document.sweater6.src = "Images/kid-ss6-4.jpg";
...
//Winter Wear boys Clothing- Sweatshirts & Sweaters 7
var sweater6 = [
   "Images/kid-ss7.jpg",
   "Images/kid-ss7-2.jpg",
   "Images/kid-ss7-3.jpg",
];
var ss6 = 0;
document.sweater7.src = "Images/kid-ss7.jpg";
...
function buyss7() {
   ...
   if (buySweater <= 10 && buySweater > 0) {
      document.querySelector("#total-ss7").textContent =
         "Total Price : " + "₹" + 493 * buySweater + "  only";
      alert("Thank ♥ you for Your Order");
   } else if (buySweater === 0) {
      alert("Enter valid number");
   } else {
...
function ss7Type1() {
   document.sweater7.src = "Images/kid-ss7-4.jpg";
   document.querySelector("#color-name4").innerHTML = " Color: Maroon/Black";
}
document.querySelector("#ss7-type2").addEventListener("mouseover", ss7Type2);
function ss7Type2() {
   document.sweater7.src = "Images/kid-ss7-5.jpg";
...
function ss7Type3() {
   document.sweater7.src = "Images/kid-ss7-6.jpg";
...
//Winter Wear boys Clothing- Sweatshirts & Sweaters 8
var sweater7 = [
   "Images/kid-ss8.jpg",
   "Images/kid-ss8-2.jpg",
   "Images/kid-ss8-3.jpg",
];
var ss7 = 0;
document.sweater8.src = "Images/kid-ss8.jpg";
...
function buyss8() {
   ...
   if (buySweater <= 10 && buySweater > 0) {
      document.querySelector("#total-ss8").textContent =
         "Total Price : " + "₹" + 529 * buySweater + "  only";
      alert("Thank ♥ you for Your Order");
   } else if (buySweater === 0) {
      alert("Enter valid number");
   } else {
...
//Winter Wear boys Clothing- Sweatshirts & Sweaters 9
var sweater8 = [
   "Images/kid-ss9.jpg",
   "Images/kid-ss9-2.jpg",
   "Images/kid-ss9-3.jpg",
];
var ss8 = 0;
document.sweater9.src = "Images/kid-ss9.jpg";
