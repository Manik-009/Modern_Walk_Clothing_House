...
//Winter Wear Girls Clothing- Hoodie 1
var hoodie = [
   "Images/kid-gh1.jpg",
   "Images/kid-gh1-2.jpg",
   "Images/kid-gh1-3.jpg",
];
var h = 0;
document.hoodie1.src = "Images/kid-gh1.jpg";
function setHoodie() {
...
function buyh1() {
   ...
   if (buyHoodie <= 10 && buyHoodie > 0) {
      document.querySelector("#total-h1").textContent =
         "Total Price : " + "₹" + 532 * buyHoodie + "  only";
...
function h1Type1() {
   document.hoodie1.src = "Images/kid-gh1.jpg";
   document.querySelector("#color-name").innerHTML = " Color: Mint Green";
}
document.querySelector("#h1-type2").addEventListener("mouseover", h1Type2);
function h1Type2() {
   document.hoodie1.src = "Images/kid-gh1-4.jpg";
...
function h1Type3() {
   document.hoodie1.src = "Images/kid-gh1-5.jpg";
...
function h1Type4() {
   document.hoodie1.src = "Images/kid-gh1-6.jpg";
...
function h1Type5() {
   document.hoodie1.src = "Images/kid-gh1-7.jpg";
   document.querySelector("#color-name").innerHTML = " Color: Dark Blue";
}
// -mouseout (Hoodie 1)
...
//Winter Wear Girls Clothing- Hoodie 2
var hoodie1 = [
   "Images/kid-gh2.jpg",
   "Images/kid-gh2-2.jpg",
   "Images/kid-gh2-3.jpg",
];
var h1 = 0;
document.hoodie2.src = "Images/kid-gh2.jpg";
function setHoodie1() {
...
function buyh2() {
   ...
   if (buyHoodie <= 10 && buyHoodie > 0) {
      document.querySelector("#total-h2").textContent =
         "Total Price : " + "₹" + 409 * buyHoodie + "  only";
...
//Winter Wear Girls Clothing- Hoodie 3
var hoodie2 = [
   "Images/kid-gh3.jpg",
   "Images/kid-gh3-2.jpg",
   "Images/kid-gh3-3.jpg",
];
var h2 = 0;
document.hoodie3.src = "Images/kid-gh3.jpg";
function setHoodie2() {
...
function buyh3() {
   ...
   if (buyHoodie <= 10 && buyHoodie > 0) {
      document.querySelector("#total-h3").textContent =
         "Total Price : " + "₹" + 499 * buyHoodie + "  only";
      document.querySelector("#total-h3").style.marginTop = "13px";
      alert("Thank ♥ you for Your Order");
   } else if (buyHoodie === 0) {
      alert("Enter valid number");
   } else {
...
//Winter Wear Girls Clothing- Hoodie 4
var hoodie3 = [
   "Images/kid-gh4.jpg",
   "Images/kid-gh4-2.jpg",
   "Images/kid-gh4-3.jpg",
];
var h3 = 0;
document.hoodie4.src = "Images/kid-gh4.jpg";
function setHoodie3() {
...
function buyh4() {
   ...
   if (buyHoodie <= 10 && buyHoodie > 0) {
      document.querySelector("#total-h4").textContent =
         "Total Price : " + "₹" + 769 * buyHoodie + "  only";
      alert("Thank ♥ you for Your Order");
   } else if (buyHoodie === 0) {
      alert("Enter valid number");
   } else {
...
//Winter Wear Girls Clothing- Hoodie 5
var hoodie4 = [
   "Images/kid-gh5.jpg",
   "Images/kid-gh5-2.jpg",
   "Images/kid-gh5-3.jpg",
];
var h4 = 0;
document.hoodie5.src = "Images/kid-gh5.jpg";
function setHoodie4() {
...
function buyh5() {
   ...
   if (buyHoodie <= 10 && buyHoodie > 0) {
      document.querySelector("#total-h5").textContent =
         "Total Price : " + "₹" + 1373 * buyHoodie + "  only";
      document.querySelector("#total-h5").style.marginTop = "13px";
      alert("Thank ♥ you for Your Order");
   } else if (buyHoodie === 0) {
      alert("Enter valid number");
   } else {
...
function h5Type1() {
   document.hoodie5.src = "Images/kid-gh5-4.jpg";
...
// -mouseout (Hoodie 5)
document.querySelector("#h5-type1").addEventListener("mouseout", type5Mout1);
function type5Mout1() {
   h5Type2();
}
//Winter Wear Girls Clothing- Hoodie 6
var hoodie5 = [
   "Images/kid-gh6.jpg",
   "Images/kid-gh6-2.jpg",
   "Images/kid-gh6-3.jpg",
];
var h5 = 0;
document.hoodie6.src = "Images/kid-gh6.jpg";
function setHoodie5() {
...
function buyh6() {
   ...
   if (buyHoodie <= 10 && buyHoodie > 0) {
      document.querySelector("#total-h6").textContent =
         "Total Price : " + "₹" + 885 * buyHoodie + "  only";
      document.querySelector("#total-h6").style.marginTop = "40px";
      alert("Thank ♥ you for Your Order");
   } else if (buyHoodie === 0) {
      alert("Enter valid number");
   } else {
...
function h6Type2() {
   document.hoodie6.src = "Images/kid-gh6-4.jpg";
...
function h6Type3() {
   document.hoodie6.src = "Images/kid-gh6-5.jpg";
...
//Winter Wear Girls Clothing- Hoodie 7
var hoodie6 = [
   "Images/kid-gh7.jpg",
   "Images/kid-gh7-2.jpg",
   "Images/kid-gh7-3.jpg",
];
var h6 = 0;
document.hoodie7.src = "Images/kid-gh7.jpg";
function setHoodie6() {
...
function buyh7() {
   ...
   if (buyHoodie <= 10 && buyHoodie > 0) {
      document.querySelector("#total-h7").textContent =
         "Total Price : " + "₹" + 695 * buyHoodie + "  only";
...
var hoodie7 = [
   "Images/kid-gh8.jpg",
   "Images/kid-gh8-2.jpg",
   "Images/kid-gh8-3.jpg",
];
var h7 = 0;
document.hoodie8.src = "Images/kid-gh8.jpg";
function setHoodie7() {
...
function buyh8() {
   ...
   if (buyHoodie <= 10 && buyHoodie > 0) {
      document.querySelector("#total-h8").textContent =
         "Total Price : " + "₹" + 459 * buyHoodie + "  only";
      document.querySelector("#total-h8").style.marginTop = "40px";
      alert("Thank ♥ you for Your Order");
   } else if (buyHoodie === 0) {
      alert("Enter valid number");
   } else {
...
function h8Type2() {
   document.hoodie8.src = "Images/kid-gh8-4.jpg";
...
//Winter Wear Girls Clothing- Hoodie 9
var hoodie8 = [
   "Images/kid-gh9.jpg",
   "Images/kid-gh9-2.jpg",
   "Images/kid-gh9-3.jpg",
];
var h8 = 0;
document.hoodie9.src = "Images/kid-gh9.jpg";
function setHoodie8() {
...
function buyh9() {
   ...
   if (buyHoodie <= 10 && buyHoodie > 0) {
      ...
      document.querySelector("#total-h9").style.marginTop = "40px";
      alert("Thank ♥ you for Your Order");
   } else if (buyHoodie === 0) {
      alert("Enter valid number");
   } else {
